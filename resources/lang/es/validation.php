...
return [
    ...
    [
        ...
        'dk_type' => 'tipo DK',
        'dk_code' => 'código DK',
        'customer_ref' => 'referencia del cliente',
        'customer_id' => 'cliente',
        'transport_document_type_id' => 'tipo de documento de trasnporte',
        'transport_document_type_number' => 'número de documento de trasnporte',
        'arrival_id' => 'distrito',
        'suppliers.0' => 'proveedor',
        'invoices.0' => 'factura',
        'prior_documents' => 'documentos previos',
        'email' => 'correo',
        'password' => 'contraseña',
        'role_id' => 'rol',
        'ship_id' => 'buque',
        ...
        'window' => 'ventana',
        'bank_accounts.0.bank_id' => 'banco',
        'bank_accounts.0.account_type_id' => 'tipo de cuenta',
        'bank_accounts.0.account_number' => 'número de cuenta',
        'reason_expense_id' => 'motivo',
        'advance' => 'anticipo',
        'total_value' => 'valor total',
        'credit' => 'crédito',
        'term' => 'plazo',
        'type_payment_id' => 'tipo de pago',
        'beneficiary_id' => 'beneficiario',
        'bank_account_id' => 'cuenta bancaria',
        'attached_discharge_document_id' => 'documento adjunto',
        'type_operation_id' => 'tipo de operación',
        'prior_document_id' => 'documento a emitir',
        'expense_document_file' => 'archivo adjunto',
        'code' => 'código',
        'order' => 'orden',
        'applies_to' => 'entidad',
        'status_id' => 'estado',
        'mode' => 'modo',
        'type' => 'tipo',
        'arrival_type_id' => 'tipo de arribo',
        'customs_process_id' => 'código DK',
        'issued_document_id' => 'documento a emitir',
        'regime_type_id' => 'régimen',
    ],

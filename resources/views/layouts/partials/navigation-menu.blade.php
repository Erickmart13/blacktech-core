<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 fixed w-full z-50">
    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-22">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center my-3">
                    <a href="{{ route('system.dashboard') }}">
                        <x-application-logo class="block h-[72px] w-auto" />
                    </a>
                </div>
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-14 sm:flex items-center">
                    <h1 class="text-xl font-semibold text-gray-800">
                        @yield('page-title', 'Dashboard') {{-- Valor por defecto --}}
                    </h1>
                </div>
            </div>
            ...
            <button @click="sidebarOpen = !sidebarOpen"
                class="p-2 text-gray-700 hover:text-gray-900 focus:outline-none lg:hidden">
                <!-- Icono hamburguesa -->
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('system.dashboard') }}" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}

<x-app-layout>
    ...
    <div class="flex p-4 mr-4 pl-6 px-3 gap-2 ">
        ...
        <h2 class="text-lg font-bold">Crear Nuevo Módulo</h2>
        <x-button-navigation-return class="ml-auto" href="{{ route('admin.modules.index') }}">Regresar</x-button>
    </div>

    <div class="border-2 p-5 md:p-2 lg:mx-5 shadow-xl">
        <form method="POST" action="{{ route('admin.modules.store') }}" class="flex flex-col min-w-0">
            @csrf
            <div>
                @if ($errors->any())

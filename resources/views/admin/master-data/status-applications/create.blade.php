<x-app-layout>
    ...
    <div class="border-2 p-2 lg:mx-5 shadow-xl">
        ...
        <form method="POST" action="{{ route('admin.master-data.status-applications.store') }}"
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full max-w-full md:px-3 shrink-0  md:w-4/12 md:flex-0">
                    ...
                    <select id="applies_to" name="applies_to" class="border rounded p-2 w-full">
                        ...
                        @foreach ($entities as $entity)
                            <option value="{{ $entity }}" {{ old('applies_to') == $entity ? 'selected' : '' }}>
                                {{ $entity }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="w-full max-w-full md:px-3 shrink-0 md:w-3/12 md:flex-0">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="status_id">Estado</label>

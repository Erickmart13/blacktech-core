...
class BlackTechTheme extends Tailwind
{
    ...
    public function table(): array
    {
        return [
            ...
            'header' => [
                ...
                'tr' => '',
                'th' => 'font-extrabold px-3 py-3 text-center text-xs text-pg-primary-700 tracking-wider whitespace-nowrap dark:text-pg-primary-300',
                'thAction' => '!font-bold',
            ],
    ...
    {
        return [
            'view' => 'components.powergrid.toggleable',
        ];
    }
